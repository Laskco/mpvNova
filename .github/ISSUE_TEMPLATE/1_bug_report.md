...
<!-- If you have compiled mpvNova yourself instead of using one of the release builds, MAKE SURE TO MENTION THIS. -->

Which version of mpvNova introduced the problem (if known):
