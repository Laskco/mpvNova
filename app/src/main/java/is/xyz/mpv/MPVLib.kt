...
@Suppress("unused")
object MPVLib {
    fun create(appctx: Context) = NativeMPVLib.create(appctx)
    fun init() = NativeMPVLib.init()
    fun destroy() = NativeMPVLib.destroy()
    fun attachSurface(surface: Surface) = NativeMPVLib.attachSurface(surface)
    fun detachSurface() = NativeMPVLib.detachSurface()

    fun command(cmd: Array<out String>) = NativeMPVLib.command(cmd)

    fun setOptionString(name: String, value: String): Int = NativeMPVLib.setOptionString(name, value)

    fun grabThumbnail(dimension: Int): Bitmap? = NativeMPVLib.grabThumbnail(dimension)

    fun getPropertyInt(property: String): Int? = NativeMPVLib.getPropertyInt(property)
    fun setPropertyInt(property: String, value: Int) = NativeMPVLib.setPropertyInt(property, value)
    fun getPropertyDouble(property: String): Double? = NativeMPVLib.getPropertyDouble(property)
    fun setPropertyDouble(property: String, value: Double) = NativeMPVLib.setPropertyDouble(property, value)
    fun getPropertyBoolean(property: String): Boolean? = NativeMPVLib.getPropertyBoolean(property)
    fun setPropertyBoolean(property: String, value: Boolean) = NativeMPVLib.setPropertyBoolean(property, value)
    fun getPropertyString(property: String): String? = NativeMPVLib.getPropertyString(property)
    fun setPropertyString(property: String, value: String) = NativeMPVLib.setPropertyString(property, value)
