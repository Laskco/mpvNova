...
private fun MPVActivity.handlePlaybackDrawerAction(
    ...
    when (action) {
        ...
        PlayerDrawerAction.SEGMENT_SKIPPING -> {
            dismissDrawerExpectingReopen(dismiss); openSegmentSkippingPanel()
        }
...
private fun MPVActivity.handleInterfaceDrawerAction(
    ...
    when (action) {
        ...
        PlayerDrawerAction.APPEARANCE_COLORS -> pickPlayerAppearanceColor()
